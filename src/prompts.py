...
def brainstorm_icebreaker_questions(
    ...
    initial_prompt = (
        ...
        f"You can ask an open ended questions instead of multiple choice questions for one of the {n_questions} questions "
        "as long as you make them easy to answer like "
