...
def brainstorm_icebreaker_questions(
    ...
    initial_prompt = (
        ...
        f"You can ask open ended questions instead of multiple choice questions for 1 of the {n_questions} questions "
        "as long as the open ended question start with 'Why do you think that ' in order to illicit peoples preferences "
        "\n"
